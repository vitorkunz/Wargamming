...
export default function UnitCreation({ 
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md border border-slate-200 mb-6 w-full max-w-4xl">
      ...
      <form onSubmit={handleCreateUnit} className="flex flex-wrap gap-4 items-end">
        <div>
        ...
        <div>
          ...
          <select className="border border-slate-300 rounded p-2 text-slate-700 bg-white" value={type} onChange={(e) => setType(e.target.value)}>
